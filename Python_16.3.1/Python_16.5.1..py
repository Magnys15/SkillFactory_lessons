...
class ItemViewEvent(Event):
    type = "itemViewEvent"      # переопределение атрибута
...
print(test_view_event)
print(test_view_event.timestamp)
print(test_view_event.session_id)
print(test_view_event.number_of_views)

# print(test_view_event.type) Атрибута не существует если не переопределить или не задать его в наследнике
